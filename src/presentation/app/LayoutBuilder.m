classdef LayoutBuilder
    ...
    methods (Static)
        ...
        function buildBody(app)
            ...
            labels = NavigationManager.navMenuLabels();
        ...
        function buildLoadingOverlay(app)
            ...
            app.LoadingOverlay.HTMLSource = [ ...
                ...
                'background:rgba(247,248,252,0.85);display:flex;' ...
                'align-items:center;justify-content:center;' ...
                'backdrop-filter:blur(2px);-webkit-backdrop-filter:blur(2px);}' ...
                '.content{text-align:center;}' ...
                '.spinner{width:46px;height:46px;border:5px solid #dde3ee;' ...
                'border-top-color:#2952a3;border-radius:50%;' ...
                'animation:spin 0.85s linear infinite;margin:0 auto;}' ...
                '@keyframes spin{to{transform:rotate(360deg)}}' ...
                '.msg{margin-top:18px;font-size:13px;color:#5a6478;' ...
