...
function buildToolbar(parent, vm)
    ...
    grid = uigridlayout(bar, [1 13]);
    grid.Padding = [10 6 10 6];
    grid.ColumnSpacing = 8;
    grid.ColumnWidth = {120, 90, 100, 100, 100, 110, 110, 90, 90, 90, 100, '1x', 160};
    ...
    btnImportData = uibutton(grid, 'Text', Labels.get('composer_btn_import_data'), ...
        'ButtonPushedFcn', @(~,~) vm.onImportDataFromMatlab());
    StyleHelper.styleBtn(btnImportData, 'ghost');
