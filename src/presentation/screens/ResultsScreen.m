...
function ResultsScreen(app)
    ...
    app.ResultsViewReconstructionBtn = uibutton(bg, ...
        'Text', [char(9986) ' ' ...
            Labels.get('results_btn_view_reconstruction', 'View Reconstruction')], ...
        'ButtonPushedFcn', @(~,~)app.ResultsVm.onViewReconstruction());
    app.ResultsViewReconstructionBtn.Layout.Row = 1;
    app.ResultsViewReconstructionBtn.Layout.Column = 3;
    app.styleBtn(app.ResultsViewReconstructionBtn, 'secondary');
    app.ResultsViewReconstructionBtn.Enable = 'off';
    app.ResultsViewReconstructionBtn.Tooltip = ...
