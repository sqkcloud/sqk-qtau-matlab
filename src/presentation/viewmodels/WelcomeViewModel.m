classdef WelcomeViewModel < handle
    ...
    methods
        ...
        function onCreateProject(obj)
            ...
            AsyncRunner.run( ...
                @() svc.createProject(char(projName), char(projDesc), tags, token), ...
        ...
        function onSaveProject(obj)
            ...
            token = app.State.authToken;
            AsyncRunner.run( ...
                @() svc.updateProject(char(projectId), char(projName), char(projDesc), tags, token), ...
        ...
        function onDeleteProject(obj)
            ...
            token = app.State.authToken;
            AsyncRunner.run( ...
                @() svc.deleteProject(char(projectId), token), ...
