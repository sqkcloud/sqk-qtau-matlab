classdef TemplateRegistry
    % TemplateRegistry  Catalogue of 12 curated quantum-circuit templates
    ...
    %   Deutsch-Jozsa_n) build their gate list at instantiate-time from the
    %   user-supplied parameters. Static templates (Bell, Phase Estimation
    %   toy, VQE H2, QAOA Max-Cut, Trotter, Teleportation, Superdense)
