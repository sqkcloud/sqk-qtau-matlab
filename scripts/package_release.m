...
%   new one, and File Exchange would treat it as a brand-new submission.
    ...
    opts.AuthorName       = 'SQK Cloud Inc.';
    opts.AuthorEmail      = 'engineering@sqkcloud.com';   % update with real maintainer email
    ...
    opts.Description      = sprintf([ ...
        'A professional MATLAB R2025a+ desktop client for managing quantum-circuit experiments ' ...
